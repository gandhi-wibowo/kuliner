...
--
-- Host: localhost    Database: db_kuliner
-- ------------------------------------------------------
...
CREATE TABLE `kuliner` (
  ...
  `nama_kuliner` varchar(35) NOT NULL,
  `alamat_kuliner` varchar(35) NOT NULL,
  `kategori_kuliner` varchar(35) NOT NULL,
...
-- Dump completed on 2017-06-15  1:49:52
